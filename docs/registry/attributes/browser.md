...
- [Deprecated Browser Attributes](#deprecated-browser-attributes)
...
## Deprecated Browser Attributes

The deprecated web browser attributes

**Attributes:**

| Key | Stability | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- |
| <a id="browser-platform" href="#browser-platform">`browser.platform`</a> | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `user_agent.os.name`. | string | The platform on which the browser is running [4] | `Windows`; `macOS`; `Android` |
