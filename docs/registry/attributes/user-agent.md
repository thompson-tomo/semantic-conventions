...
**[1] `user_agent.name`:** [Example](https://uaparser.dev/#demo) of extracting browser's name from original string. In cases where multiple browsers are embedded (e.g., Chrome-based browsers), the primary browser name SHOULD be selected. With the complete list of browsers stored in `browser.brands`.
