...
**Summary:** This section defines generic attributes for AWS services.
...
**Summary:** This document defines attributes for AWS Bedrock.
...
**Summary:** This document defines attributes for AWS DynamoDB.
...
**Summary:** This document defines attributes for AWS Elastic Container Service (ECS).
...
**Summary:** This document defines attributes for AWS Elastic Kubernetes Service (EKS).
...
**Summary:** This document defines attributes for AWS Kinesis.
...
**Summary:** This document defines attributes for AWS Lambda.
...
**Summary:** This document defines attributes for AWS Logs.
...
**Summary:** This document defines attributes for AWS S3.
...
**Summary:** This document defines attributes for AWS Secrets Manager.
...
**Summary:** This document defines attributes for AWS SNS.
...
**Summary:** This document defines attributes for AWS SQS.
...
**Summary:** This document defines attributes for AWS Step Functions.
