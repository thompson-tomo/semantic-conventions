...
| --- | --- | --- | --- | --- |
| `instrumentation/development.general.rpc.semconv.version` | `Conditionally-Required` | Version Selector | `1` | - |
| `instrumentation/development.general.rpc.semconv.experimental` | `Required` | Experimental Opt-in | `true` | [`rpc.method`](/docs/registry/attributes/rpc.md) [`rpc.method_original`](/docs/registry/attributes/rpc.md) [`rpc.response.status_code`](/docs/registry/attributes/rpc.md) [`rpc.system.name`](/docs/registry/attributes/rpc.md) |
| `instrumentation/development.general.rpc.semconv.dup` | `Required` | Deprecated Opt-in | `true` | [`rpc.system`](/docs/registry/attributes/rpc.md) |

**Environment Variable Options:**

| Setting | Requirement Level | Category | Example Value | Attribute |
| --- | --- | --- | --- | --- |
| `OTEL_SEMCONV_STABILITY_OPT_IN` | Conditionally Required | Experimental Opt-in | `rpc` | [`rpc.method`](/docs/registry/attributes/rpc.md) [`rpc.method_original`](/docs/registry/attributes/rpc.md) [`rpc.response.status_code`](/docs/registry/attributes/rpc.md) [`rpc.system.name`](/docs/registry/attributes/rpc.md) |
| `OTEL_SEMCONV_STABILITY_OPT_IN` | Conditionally Required | Deprecated Opt-in | `rpc/dup` | [`rpc.method`](/docs/registry/attributes/rpc.md) [`rpc.method_original`](/docs/registry/attributes/rpc.md) [`rpc.response.status_code`](/docs/registry/attributes/rpc.md) [`rpc.system`](/docs/registry/attributes/rpc.md) [`rpc.system.name`](/docs/registry/attributes/rpc.md) |
